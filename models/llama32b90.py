...
class Llama3_2B90():
    def __init__(self, model="meta-llama/Llama-3.2-90B-Vision-Instruct-Turbo",tempt=0, top_p=1, seed=42):
        config = dotenv_values(".env")        
        self.model = model
        self.client = OpenAI(api_key=config["HF_API_KEY"], base_url="https://router.huggingface.co/together/v1")
        self.tempt = tempt
        self.top_p = top_p
        self.seed = seed
